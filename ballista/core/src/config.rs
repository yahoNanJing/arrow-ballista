...
// needs to be visible to code generated by configure_me
#[derive(Clone, ArgEnum, Copy, Debug, serde::Deserialize)]
pub enum SourceDataCachePolicy {
    LocalDiskFile,
}

impl std::str::FromStr for SourceDataCachePolicy {
    type Err = String;
...
impl parse_arg::ParseArgFromStr for SourceDataCachePolicy {
    fn describe_type<W: fmt::Write>(mut writer: W) -> fmt::Result {
        write!(writer, "The source data cache policy")
    }
}
